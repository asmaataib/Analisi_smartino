...
#Mi fornisce la confusion matrix 
# #"""
# ADVANCED ML MODELS FOR RESPIRATORY DISEASE PREDICTION
# Fixed version with AdaBoost compatibility
# #"""
...
plt.close()
print('   ✅ Confusion matrix saved as Confusion_matrix_fixed.png')
...
if hasattr(best_model, 'feature_importances_'):
    ...
    plt.tight_layout()
    plt.savefig('Feature_importance_best_model_fixed.png', dpi=300, bbox_inches='tight')
    plt.close()
    print('   ✅ Feature importance plot saved as Feature_importance_best_model_fixed.png')
